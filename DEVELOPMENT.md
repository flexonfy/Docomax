...
```bash
git remote add encore encore://afrihealth-advisor-pwa-pq4i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/afrihealth-advisor-pwa-pq4i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/afrihealth-advisor-pwa-pq4i/settings/integrations/github)
